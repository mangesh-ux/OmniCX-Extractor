...
| Latency (mean) | 29.84s |
| Latency (min / max) | 16.89s / 45.72s |
| Latency (total) | 954.94s |
...
- **Line 4**: missed customer_intent, customer_effort_score, sentiment_trajectory, rework_frequency
...
- **Line 25**: missed customer_effort_score, rework_frequency, root_cause_category
