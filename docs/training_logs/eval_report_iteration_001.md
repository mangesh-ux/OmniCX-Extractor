...
| Latency (mean) | 22.35s |
| Latency (min / max) | 17.22s / 29.43s |
| Latency (total) | 715.33s |

## Per-field accuracy

| Field | Correct | Accuracy |
|-------|---------|----------|
| customer_intent | 18/32 | 56.2% |
| customer_effort_score | 13/32 | 40.6% |
| sentiment_trajectory | 21/32 | 65.6% |
| rework_frequency | 20/32 | 62.5% |
...
| agent_explicitly_confirmed_resolution | 26/32 | 81.2% |
| unresolved_next_steps | 27/32 | 84.4% |
...
- **Line 3**: missed delivery_exception_type, root_cause_category
...
- **Line 14**: missed customer_effort_score, delivery_exception_type
- **Line 15**: missed customer_intent, agent_explicitly_confirmed_resolution
- **Line 16**: missed customer_intent, customer_effort_score, root_cause_category
...
- **Line 18**: missed rework_frequency, agent_explicitly_confirmed_resolution, unresolved_next_steps
...
- **Line 23**: missed customer_effort_score, sentiment_trajectory, delivery_exception_type, root_cause_category
